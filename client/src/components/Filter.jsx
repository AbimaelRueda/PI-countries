...
export default function Filter(){
    ...
    React.useEffect(() =>
    {
        ...
        else if(typeFilter.typeCont !== '' && typeFilter.typeAct === '') return dispatch(setFilters(orderList(filterByContinent(countries))));
        else if(typeFilter.typeCont === '' && typeFilter.typeAct !== '') return dispatch(setFilters(orderList(filterByActivity(countries))));
        else
        {
            let myFilter = orderList(filterByActivity(filterByContinent(countries)));
